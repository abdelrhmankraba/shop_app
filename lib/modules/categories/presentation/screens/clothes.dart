        ...
        return Scaffold(
          ...
          body: ConditionalBuilder(
            ...
            builder:(context) => ListView.separated(
              ...
              itemBuilder: (context , index) => buildListCatProduct(ShopCategoriesCubit.get(context).clothes!.data.data[index],context),
              ...
              itemCount: ShopCategoriesCubit.get(context).clothes!.data.data.length,
            ),
