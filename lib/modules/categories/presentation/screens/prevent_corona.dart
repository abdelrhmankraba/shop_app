        ...
        return Scaffold(
          ...
          body: ConditionalBuilder(
            ...
            builder:(context) => ListView.separated(
              ...
              itemBuilder: (context , index) => buildListCatProduct(ShopCategoriesCubit.get(context).preventCorona!.data.data[index],context),
              ...
              itemCount: ShopCategoriesCubit.get(context).preventCorona!.data.data.length,
            ),
